...
require('header.php');
include('session.php');
$sayi =$_SESSION['superhero'];
echo $sayi;

//burada eklenen kategori ismi ile gidip min id yi bulucaz bunu da sonraında 
//burada eklediğimiz altkategori ismi ve min idyi uid ile databaseye göndericez

$lastid = $connect->lastInsertId();


if (isset($_GET['existed'])) {
    $category_name = $_GET['existed'];
